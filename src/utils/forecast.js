...
const forecast = ( (latitude, longitude, callback) => {
    ...
    request({ url: url, json: true },(error, response) => {
        ...
        response.body.current.precip +' % change of rain'+'\n'+ 'It is currently '+response.body.current.temperature +' It Feels like its '+response.body.current.feelslike+'\n'+'Humudity is '+response.body.current.humidity+'Percentage' )
